      ...
      appInterface.innerHTML = `
        ...
        <div class="content-area">
          ...
          <div id="generate-metadata" class="tab-content">
            <h2 class="section-title">Generate Metadata</h2>
            <p class="section-description">Create and customize metadata for your NFT collection.</p>
            <!-- Content will be added based on your instructions -->
          </div>
          
          <div id="export-nfts" class="tab-content">
            <h2 class="section-title">Export NFTs</h2>
            <p class="section-description">Export your NFT collection and metadata.</p>
            <!-- Content will be added based on your instructions -->
          </div>
        </div>
